...
public class SigninActivity extends AppCompatActivity implements ServiceListener {
   ...
   // EditText user_edit;
    ...
    public void signIn() {
        ...
        sessionManager.setCountryCode(ccp.getSelectedCountryCodeWithPlus()
                .replaceAll("\\+", ""));
...
String jsonString =jsonResp.getStrResponse();
if(!jsonString.endsWith("}")){
    jsonString+="}";
}
        LoginDetails signInUpResultModel = gson.fromJson(jsonString, LoginDetails.class);
