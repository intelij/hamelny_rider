...
public class RequestReceiveActivity extends AppCompatActivity implements LinearTimer.TimerListener, ServiceListener {
        ...
        if (JSON_DATA != null) {
            try {
                ...
                if (jsonObject.getJSONObject("custom").has("ride_request")) {
                    ...
                    pickup_address = jsonObject.getJSONObject("custom")
                            .getJSONObject("ride_request").getString("pickup_location");
    ...
    */
    ...
    public void onSuccess(JsonResponse jsonResp, String data) {
        Log.v("ccccccccccccxxxx"," vvvv    "+jsonResp.getStrResponse());
        if (jsonResp.isSuccess()) {
            onSuccessAccept(jsonResp);
        } else if (!TextUtils.isEmpty(jsonResp.getStatusMsg())) {
            commonMethods.showMessage(this, dialog, jsonResp.getStatusMsg());
            Log.v("ccccccccccccxxxx",",,,,,,,,,,,,,,,,,,,,,nvvg");
            pd.dismiss();
            Intent requestaccept = new Intent(getApplicationContext(), MainActivity.class);
            startActivity(requestaccept);
            finish();
    ...
    public void onFailure(JsonResponse jsonResp, String data) {
        ...
        Log.v("cccccccccc",jsonResp.getStrResponse());
    ...
    */
    public void acceptDriver() {
        ...
        apiService.acceptRequest(sessionManager.getType(),
                req_id, "Trip",
                sessionManager.getAccessToken()).enqueue(new RequestCallback(this));
    }
