...
public class NetworkModule {
    ...
    NetworkModule(String baseUrl) {
        //this.mBaseUrl = "http://157.245.237.176/hamelly/public/api/";

        //this.mBaseUrl = "http://bsamat.com/demo/ryde/public/api/";

        this.mBaseUrl="http://192.168.1.152:8000/api/";

        //this.mBaseUrl = "http://128.199.163.245/hamelly/public/index.php/api/";
    }
